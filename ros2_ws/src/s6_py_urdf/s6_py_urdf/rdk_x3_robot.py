...
class StatePublisher(Node):
    ...
    def publish(self):
        ...
        joint_state.name = ['left_front_joint','left_back_joint','right_front_joint','right_back_joint']
        joint_state.position = [self.wheel_angle,self.wheel_angle,-self.wheel_angle,-self.wheel_angle]
